...
for i in range(no_of_nodes):
    if load_node(WorkChain_nodes[i][0].pk).attributes['process_state'] == 'killed':
        continue
    else:
        solute_labels= []
        qb = QueryBuilder()
        ...
        for calc_id in CalcJobNode_ids:
                ...
                solutes[label]['ALPHA'] = ALPHA
                solutes[label]['BETA'] = BETA
                solutes[label]['GAMMA'] = GAMMA
        ...
        fieldnames  = ["label", "expt_energy", "E_vac" , "E_sol0_0",  "volume_sol0_0", "surface_sol0_0", "E_sol1_0", "volume_sol1_0", "surface_sol1_0", "ALPHA", "BETA", "GAMMA"]
