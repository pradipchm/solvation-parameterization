...
#column_names = ["label", "expt_energy", "E_vac" , "E_sol0_0",  "volume_sol0_0", "surface_sol0_0", "E_sol1_0", "volume_sol1_0", "surface_sol1_0" , "ALPHA", "BETA", "GAMMA"]
...
for sol in solvent_files:
    ...
    ALPHA = df['ALPHA'].to_list()[0]
    BETA = df['BETA'].to_list()[0]
    GAMMA = df['GAMMA'].to_list()[0]
    ...
    data.append(result)
    fieldnames  = ["solvent", "mse", "grad_alpha" , "grad_beta",  "grad_gamma" , "ALPHA", "BETA", "GAMMA"]
